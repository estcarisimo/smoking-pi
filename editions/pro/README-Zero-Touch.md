...
```bash
# Step 1: Run the unified setup script (REQUIRED)
./setup.sh
...
- ✅ **Configures database** with schema and default data automatically
...
6. **Database Configuration**: Automatic schema initialization with default DNS resolvers
...
| **Corporate/Restricted** | 🔄 Auto-adapt | Graceful fallback based on connectivity, database auto-configured |
...
| **Database-First** | 🗄️ Modern | PostgreSQL-driven configuration with web interface management |
...
- **No complex setup** - Database schema and defaults configured automatically
...
[entrypoint] Initializing database configuration…
[entrypoint] Database schema and defaults configured
[entrypoint] Configuration completed successfully
