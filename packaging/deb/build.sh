...
# directory, not the reference Pi's last generation. (The module's own
# shared/modules/config-manager/output/ holds generic example targets and
# stays: it is documentation, not state.)
